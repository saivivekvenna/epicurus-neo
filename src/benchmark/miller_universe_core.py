...
CODE_FILES = (
    ...
    ROOT / "scripts/miller_patient_reconstruct.py",
    ROOT / "scripts/miller_reconstruct.py",
    ROOT / "scripts/miller_hu287_somatic.sh",
    ROOT / "scripts/miller_hu287_hla.sh",
    ROOT / "scripts/miller_hu287_rna.sh",
