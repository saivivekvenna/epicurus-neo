...
_frozen SHA-256 `f578b1662a4209dc`; data: data/raw/gartner_nci/_cache_improve_prime.tsv, data/raw/improve/data.zip (NO Sid). Quarantined 731/17520 peptide-leaked held-out rows; selection on leakage-clean only. null hits clean=80.0._
...
|---|--:|--:|--:|---|---|---|:--:|---|
| core_deployable | 83 | 80 | +3 | {'Basket': 1.0, 'bladder': 1.0, 'melanoma': 1.0} | +0.043 [-0.0429, 0.1286] 0.8004 | 77.0 (y) | yes | [(0, 0.1, 1), (1, 0.0, 3), (2, 0.5, 1), (3, 0.1, 1), (4, 0.2, 1)] |
| improve_rich_partial_bridge | 83 | 80 | +3 | {'Basket': 0.0, 'bladder': 2.0, 'melanoma': 1.0} | +0.043 [-0.0429, 0.1429] 0.7726 | 77.25 (y) | yes | [(0, 0.1, 1), (1, 0.0, 3), (2, 0.5, 3), (3, 0.3, 1), (4, 0.2, 1)] |
...
|---|--:|--:|--:|--:|---|--:|:--:|
| core_deployable | 0.5 | 0.1 | 1 | 88 (+8) | {'Basket': 2.0, 'bladder': 3.0, 'melanoma': 3.0} | 82.15 | y |
| core_deployable | 1.0 | 0.1 | 1 | 88 (+8) | {'Basket': 2.0, 'bladder': 3.0, 'melanoma': 3.0} | 82.15 | y |
| core_deployable | 2.0 | 0.5 | 1 | 88 (+8) | {'Basket': 2.0, 'bladder': 3.0, 'melanoma': 3.0} | 83.6 | y |
| core_deployable | 0.5 | 0.25 | 1 | 87 (+7) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 4.0} | 82.55 | y |
| core_deployable | 1.0 | 0.25 | 1 | 87 (+7) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 4.0} | 82.55 | y |
| core_deployable | 1.0 | 0.5 | 1 | 87 (+7) | {'Basket': 2.0, 'bladder': 3.0, 'melanoma': 2.0} | 82.7 | y |
| core_deployable | 2.0 | 0.1 | 1 | 87 (+7) | {'Basket': 1.0, 'bladder': 3.0, 'melanoma': 3.0} | 81.15 | y |
| core_deployable | 0.5 | 0.2 | 1 | 86 (+6) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 3.0} | 81.35 | y |
| core_deployable | 0.5 | 0.5 | 1 | 86 (+6) | {'Basket': 1.0, 'bladder': 3.0, 'melanoma': 2.0} | 81.7 | y |
| core_deployable | 1.0 | 0.2 | 1 | 86 (+6) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 3.0} | 81.35 | y |
| core_deployable | 2.0 | 0.2 | 1 | 86 (+6) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 3.0} | 81.3 | y |
| core_deployable | 2.0 | 0.25 | 1 | 86 (+6) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 3.0} | 81.5 | y |
| core_deployable | 0.5 | 0.0 | 1 | 85 (+5) | {'Basket': 0.0, 'bladder': 3.0, 'melanoma': 2.0} | 79.55 | y |
| core_deployable | 0.5 | 0.3 | 1 | 85 (+5) | {'Basket': 1.0, 'bladder': 2.0, 'melanoma': 2.0} | 80.35 | y |

## FROZEN (§6, leakage-clean)
arm **core_deployable** α=0.1 q=1 C=0.5 clean_hits=88; multiplicity 180 configs; external transport {'gartner': {'base': 18, 'gated': 18, 'delta': 0, 'note': 'ANCHORED-COMPONENT-ONLY: q reserve DISABLED externally (no comparable mutant-RNA signal); VAF/RNA features neutral where absent. Not the full frozen policy.'}, 'multimer': {'base': 21, 'gated': 22, 'delta': 1, 'note': 'ANCHORED-COMPONENT-ONLY: q reserve DISABLED externally (no comparable mutant-RNA signal); VAF/RNA features neutral where absent. Not the full frozen policy.'}}. SHA-256 `f578b1662a4209dc8eb87fb4f30b3583572b3b5507fa85c58e59820778f310b8`.
